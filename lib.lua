...
function library:window(properties)
	...
	local function create_player(player)
		...
		local p_neutral = library:create("TextButton", {
			Parent = expanded,
			Text = "N",
		...
		p_neutral.MouseButton1Click:Connect(function()
			...
			priority_label.TextColor3 = Color3.fromRGB(150, 150, 150)
		end)
		...
		library:create("UIStroke", { Parent = btn_cpname, Color = Color3.fromRGB(57, 57, 57) })
		...
		library:create("UIStroke", { Parent = btn_cpid, Color = Color3.fromRGB(57, 57, 57) })
